...
namespace PcapFileHandler {
    public class PcapFileReader : PcapStreamReader {
        ...
        public PcapFileReader(string filename, int packetQueueSize, CaseFileLoadedCallback readCompleteCallback, bool startBackgroundWorkers)
            : this(filename, new System.IO.FileStream(filename, FileMode.Open, FileAccess.Read, FileShare.Read, 262144, FileOptions.SequentialScan), packetQueueSize, readCompleteCallback, startBackgroundWorkers) { }
