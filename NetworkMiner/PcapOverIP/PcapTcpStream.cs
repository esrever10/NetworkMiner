...
namespace NetworkMiner.PcapOverIP {
    public class PcapTcpStream : IDisposable {
        ...
        public PcapTcpStream(ushort tcpPort, bool useSsl, int idleTimeoutMilliSeconds) {
            this.socketState = TcpSocketState.Closed;
            this.tcpListener = new System.Net.Sockets.TcpListener(System.Net.IPAddress.Any, (int)tcpPort);
            tcpListener.Start();
