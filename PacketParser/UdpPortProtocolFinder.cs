...
namespace PacketParser {
    public class UdpPortProtocolFinder : IPortProtocolFinder {
        ...
        public PacketParser.ApplicationLayerProtocol GetApplicationLayerProtocol(PacketParser.TransportLayerProtocol transport, ushort sourcePort, ushort destinationPort) {
