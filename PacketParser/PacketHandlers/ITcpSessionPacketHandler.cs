...
namespace PacketParser.PacketHandlers {
    ...
    interface ITcpSessionPacketHandler {
        ...
        */
        ...
        /// <param name="packetList"></param>
        /// <returns>
        /// The number of bytes of data that were successfully extracted. Should be zero if the protocol was incorrect.
        /// Not parsed data will be saved and merged with future data arriving in the TCP session
        /// </returns>
        int ExtractData(NetworkTcpSession tcpSession, NetworkHost sourceHost, NetworkHost destinationHost, IEnumerable<Packets.AbstractPacket> packetList);
