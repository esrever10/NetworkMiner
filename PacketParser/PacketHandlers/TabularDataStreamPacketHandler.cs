...
namespace PacketParser.PacketHandlers {
    class TabularDataStreamPacketHandler : AbstractPacketHandler, ITcpSessionPacketHandler {
        ...
        private int ExtractData(NetworkTcpSession tcpSession, NetworkHost sourceHost, NetworkHost destinationHost, Packets.TabularDataStreamPacket tdsPacket) {
            ...
            if(tdsPacket.PacketType==(byte)Packets.TabularDataStreamPacket.PacketTypes.SqlQuery) {
                ...
                if(sqlParams.Count>0)
                    base.MainPacketHandler.OnParametersDetected(new Events.ParametersEventArgs(tdsPacket.ParentFrame.FrameNumber, sourceHost, destinationHost, "", "", sqlParams, tdsPacket.ParentFrame.Timestamp, ""));
                    //base.MainPacketHandler.ParentForm.ShowParameters
            }
